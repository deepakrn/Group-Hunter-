...
public class FindGroup extends Fragment implements OnItemSelectedListener,OnQueryTextListener {
	
	private ArrayList<Group> classes=new ArrayList<Group>();
	private ArrayList<Group> dup;
	SearchView s;
	...
	public View onCreateView(LayoutInflater inflater,
		...
		return inflater.inflate(R.layout.fragment_findgroup, container,false);
	} 
	...
	private void populateGroupList() {
		// TODO Auto-generated method stub
		classes.add(new Group("CSC-505", "Algorithms", "deepak"));
		classes.add(new Group("CSC-520", "ArtificialIntelligence", "neha"));
		classes.add(new Group("CSC-501", "Operating Systems", "joe"));
		classes.add(new Group("CSC-502", "HCI", "harry"));
		classes.add(new Group("CSC-505", "Game AI", "alice"));
	
		dup=(ArrayList<Group>)classes.clone();
	}
	@Override
        ...
        spinner.setOnItemSelectedListener(this);
         ...
         s.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
			...
			public boolean onQueryTextSubmit(String query) {
				 Filter f=FindGroup.this.adapter.getFilter();
				f.filter(query);	
				return false;
			}
...
private class MyListAdapter extends ArrayAdapter<Group>{
		...
		private ArrayList<Group> filteredModelItemsArray=new ArrayList<Group>();
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			Group currentClass=classes.get(position);
			...
			if (filter == null){
		          filter = new Filter(){
		        	...
		        	protected FilterResults performFiltering(
		                ...
		                {
		                    ArrayList<Group> filteredItems = new ArrayList<Group>();
					...
					protected void publishResults(CharSequence constraint,
						...
						filteredModelItemsArray = (ArrayList<Group>)results.values;					       
				        clear();
